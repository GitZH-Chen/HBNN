...
class LorentzFullyConnected(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.weight(self.dropout_fn(x))
    ...
    def extra_repr(self):
        return f'manifold={self.manifold}, in_features={self.in_features},out_features={self.out_features}, ' \
               f'dropout={self.dropout}' \
               f'bias={self.bias},init_scale={self.init_scale}, learn_scale={self.learn_scale},normalize={self.normalize}'
