...
- `lib/bnn/evaluation/vis_horosphere.py` provides the visualization function and script for horospheres.
- The plotted results reproduce Figure 1 in the paper.
